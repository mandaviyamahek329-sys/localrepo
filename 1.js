...
!function(e, t) {
    ...
    const v = new RegExp(Object.keys(g).join("|") + "|[̀-ͯ·ʾʼ]","gu")
      ...
      , O = e => (e = m(e).toLowerCase().replace(v, (e => g[e] || "")),
    m(e, "NFC"))
    const b = e => {
        const t = {}
          , i = (e, i) => {
      ...
      , w = e => {
        ...
        for (let e in t) {
            let i = t[e]
            i && (s[e] = n(i)),
            e.length > 1 && o.push(r(e))
        }
        o.sort(( (e, t) => t.length - e.length))
        const l = i(o)
        return h = new RegExp("^" + l,"u"),
        s
    }
      , _ = (e, t=1) => (t = Math.max(t, e.length - 1),
    i(d(e).map((e => ( (e, t=1) => {
        let i = 0
        return e = e.map((e => (p[e] && (i += e.length),
        p[e] || e))),
        i >= t ? s(e) : ""
    }
    )(e, t)))))
    ...
    class P {
        ...
        tokenize(e, t, i) {
            ...
            const s = []
              , n = e.split(/\s+/)
            var o
            return i && (o = new RegExp("^(" + Object.keys(i).map(r).join("|") + "):(.*)$")),
            n.forEach((e => {
                let i, n = null, l = null
                o && (i = e.match(o)) && (n = i[1],
                e = i[2]),
                e.length > 0 && (l = this.settings.diacritics ? A(e) || null : r(e),
                l && t && (l = "\\b" + l)),
                s.push({
                    string: e,
    ...
    function ae(e, t) {
        ...
        return "select" === d ? ( () => {
            ...
            N(e.children, (e => {
                var i, s, n
                "optgroup" === (t = e.tagName.toLowerCase()) ? ((n = f(i = e))[a] = n[a] || i.getAttribute("label") || "",
                n[c] = n[c] || h++,
                n[r] = n[r] || i.disabled,
                n.$order = n.$order || ++g,
                p.optgroups.push(n),
    ...
    class de extends (function(e) {
        ...
        constructor(e, t) {
            ...
            this.sifter = new P(this.options,{
            ...
            $(n.controlInput)) {
                ...
                n.controlInput ? (p = j(n.controlInput),
                this.focus_node = p) : (p = j("<input/>"),
                this.focus_node = l)
            this.wrapper = r,
            this.dropdown = a,
        ...
        setup() {
            ...
            !t.splitOn && t.delimiter && (t.splitOn = new RegExp("\\s*" + r(t.delimiter) + "+\\s*")),
        ...
        onInput(e) {
            ...
            this.lastValue !== t && (this.lastValue = t,
            "" != t ? (this.refreshTimeout && clearTimeout(this.refreshTimeout),
            this.refreshTimeout = ( (e, t) => t > 0 ? setTimeout(e, t) : (e.call(null),
            null))(( () => {
                this.refreshTimeout = null,
                this._onInput()
            }
        ...
        onFocus(e) {
            ...
            i || t.trigger("focus"),
            t.activeItems.length || (t.inputState(),
        ...
        load(e) {
            ...
            if (!t.canLoad(e))
                return
            D(t.wrapper, t.settings.loadingClass),
            t.loading++
        ...
        setActiveItem(e, t) {
            ...
            if ("single" !== a.settings.mode) {
                ...
                if ("click" === (i = t && t.type.toLowerCase()) && ne("shiftKey", t) && a.activeItems.length) {
                    ...
                    "click" === i && ne(J, t) || "keydown" === i && ne("shiftKey", t) ? e.classList.contains("active") ? a.removeActiveItem(e) : a.setActiveItemClass(e) : (a.clearActiveItems(),
        ...
        clearActiveOption() {
            this.activeOption && (R(this.activeOption, "active"),
            Q(this.activeOption, {
                "aria-selected": null
            })),
            this.activeOption = null,
        ...
        inputState() {
            ...
            e.isInputHidden = !0) : (e.settings.hidePlaceholder && e.items.length > 0 && Q(e.control_input, {
                placeholder: ""
            }),
            e.isInputHidden = !1),
        ...
        focus() {
            var e = this
            e.isDisabled || e.isReadOnly || (e.ignoreFocus = !0,
        ...
        refreshOptions(e=!0) {
            ...
            O.innerHTML = "",
            le(O, l),
            h.settings.highlight && (w = O.querySelectorAll("span.highlight"),
            ...
            if (h.loading ? _("loading") : h.settings.shouldLoad.call(h, g) ? 0 === v.items.length && _("no_results") : _("not_loading"),
        ...
        refreshState() {
            ...
            s.toggle("has-options", (n = e.options,
        ...
        updateOriginalInput(e={}) {
            ...
            if (t.is_select_tag) {
                ...
                function l(e, i, s) {
                    return e || (e = j('<option value="' + Z(i) + '">' + Z(s) + "</option>")),
        ...
        deleteSelection(e) {
            ...
            if (r.activeItems.length)
                ...
                let s
                t < 0 && 0 === i.start && 0 === i.length ? s = e[r.caretPos - 1] : t > 0 && i.start === r.inputValue().length && (s = e[r.caretPos]),
                void 0 !== s && l.push(s)
            }
            if (!r.shouldDelete(l, e))
                return !1
            for (ie(e, !0),
            void 0 !== s && r.setCaret(s); l.length; )
                r.removeItem(l.pop())
            return r.inputState(),
            r.positionDropdown(),
            r.refreshOptions(!1),
        ...
        advanceSelection(e, t) {
            var i, s, n = this
            n.rtl && (e *= -1),
            n.inputValue().length || (ne(J, t) || ne("shiftKey", t) ? (s = (i = n.getLastActive(e)) ? i.classList.contains("active") ? n.getAdjacent(i, e, "item") : i : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (s.classList.contains("active") && n.removeActiveItem(i),
        ...
        render(e, t) {
            ...
            if ("function" != typeof this.settings.render[e])
                return null
            if (!(s = n.settings.render[e].call(this, t, Z)))
                return null
            if (s = j(s),
            "option" === e || "option_create" === e ? t[n.settings.disabledField] ? Q(s, {
                "aria-disabled": "true"
            }) : Q(s, {
                "data-selectable": ""
            ...
            "option" === e || "item" === e) {
                ...
                "item" === e ? (D(s, n.settings.itemClass),
                Q(s, {
                    "data-ts-item": ""
    ...
    de.define("checkbox_options", (function(e) {
        ...
        var n = function(e, t) {
            t ? (e.checked = !0,
            s.uncheckedClassNames && e.classList.remove(...s.uncheckedClassNames),
            s.checkedClassNames && e.classList.add(...s.checkedClassNames)) : (e.checked = !1,
            s.checkedClassNames && e.classList.remove(...s.checkedClassNames),
            s.uncheckedClassNames && e.classList.add(...s.uncheckedClassNames))
        }
          , o = function(e) {
            setTimeout(( () => {
        ...
        t.hook("after", "setupTemplates", ( () => {
            ...
            t.settings.render.option = (i, o) => {
                ...
                return n(l, !!(a && t.items.indexOf(a) > -1)),
                r.prepend(l),
                r
            }
        }
    ...
    de.define("drag_drop", (function() {
        ...
        e.hook("after", "setupTemplates", ( () => {
            ...
            e.settings.render.item = (i, o) => {
                ...
                const l = e => {
                  ...
                  , a = (e, t) => {
                    ...
                    void 0 !== t && (( (e, t) => {
                        do {
                            var i
                            if (e == (t = null == (i = t) ? void 0 : i.previousElementSibling))
                                return !0
                        } while (t && t.previousElementSibling)return !1
                    }
                    )(t, r) ? (s = t,
                    null == (n = (i = e).parentNode) || n.insertBefore(s, i.nextSibling)) : ( (e, t) => {
                        var i
                ...
                se(r, "dragend", ( () => {
                    var t
                    document.querySelectorAll(".ts-drag-over").forEach((e => e.classList.remove("ts-drag-over"))),
        ...
        e.hook("instead", "lock", ( () => (n = !1,
        t.call(e)))),
        e.hook("instead", "unlock", ( () => (n = !0,
        i.call(e))))
    }
    )),
    ...
    de.define("dropdown_input", (function() {
        ...
        e.hook("before", "setup", ( () => {
            ...
            D(e.control_input, "dropdown-input")
    ...
    de.define("input_autogrow", (function() {
        ...
        e.on("initialize", ( () => {
            ...
            for (const e of ["letterSpacing", "fontSize", "fontFamily", "fontWeight", "textTransform"])
                t.style[e] = i.style[e]
            var s = () => {
    ...
    de.define("optgroup_columns", (function() {
        ...
        e.hook("instead", "onKeyDown", (i => {
            ...
            r && (r = 37 === i.keyCode ? r.previousSibling : r.nextSibling) && (n = (o = r.querySelectorAll("[data-selectable]"))[Math.min(o.length - 1, s)]) && e.setActiveOption(n)
        }
        ))
    }
    )),
...
class UiRichSelect {
    ...
    init() {
        $('SELECT.uiRichSelect').each( (index, element) => {
            if (!$(element).hasClass('tomselected') && !$(element).data('exclude-tomselect')) {
                this.initializeSelect($(element));
                this.observeDisabledState(element);
            }
        }
        );
        $('SELECT:not(.uiRichSelect):not(.swal2-select):not(.chosen-select):not(.uiMultipleSelect):not(.modal-select)').each( (index, element) => {
            if (!$(element).hasClass('tomselected') && !$(element).attr('class')?.includes('flatpickr') && !$(element).data('exclude-tomselect')) {
                $(element).data('option-disable-search', true);
                $(element).addClass('uiRichSelect');
                this.initializeSelect($(element));
                this.observeDisabledState(element);
            }
        }
    ...
    initializeSelect($this) {
        let direction = ($('html').attr('dir') == 'rtl') ? 'rtl' : 'ltr';
        const forceDirection = $this.data('option-force-direction') || false;
        const themeType = $this.data('option-theme') || false;
        const disableSearch = $this.data('option-disable-search') || false;
        const ajaxUrl = $this.data('option-ajax-url') || false;
        const placeholder = $this.data('placeholder') || false;
        const dropdownDirection = $this.data('dropdown-direction') || 'auto';
        if (forceDirection) {
            this.handleDirection($this, forceDirection);
            direction = forceDirection;
        }
        const {hasExplain, hasImage, updatedThemeType} = this.processOptions($this, themeType);
        let loadedInitialData = false;
        const instance = this.createTomSelectInstance($this, {
            direction,
            themeType: updatedThemeType,
            hasExplain,
            disableSearch,
            ajaxUrl,
            placeholder,
        ...
        this.setupDirectionClasses(instance, direction);
        this.calculateAutoWidth($this, instance);
        $this.data('tomselect', instance);
    }
    handleDirection($this, forceDirection) {
        $this.wrap(`<div dir="${forceDirection}"></div>`);
    }
    processOptions($this, themeType) {
        const lastOption = $this.find('option:last');
        const hasExplain = lastOption.data('explain') ? true : false;
        const hasImage = $this.find('option[data-src]').length > 0;
        return {
            hasExplain,
            hasImage,
            updatedThemeType: hasImage ? 'align_image' : themeType
        };
    }
    setupKeyboardNavigation(instance) {
        ...
        const handleKeyDown = (e) => {
            ...
            e.stopPropagation();
            const ignoredKeys = ['ArrowDown', 'ArrowUp', 'ArrowLeft', 'ArrowRight', 'Enter', 'Escape', 'Tab', 'Shift', 'Control', 'Alt', 'Meta', 'Backspace', 'Delete', 'Home', 'End', 'PageUp', 'PageDown'];
            ...
            if (e.key.length === 1) {
                ...
                const isCycling = (currentChar === lastSearchChar && typeaheadString === currentChar);
                if (isCycling) {
                    const options = instance.options;
                    const activeValue = instance.activeOption?.dataset.value;
                    let foundNext = false;
                    let firstMatch = null;
                    let foundOption = null;
                    for (let value in options) {
                        const option = options[value];
                        const optionText = (option.text || option[instance.settings.labelField] || '').toLowerCase();
                        if (optionText.startsWith(currentChar)) {
                            if (!firstMatch) {
                                firstMatch = option;
                            }
                            if (foundNext) {
                            ...
                            if (activeValue && option[instance.settings.valueField] == activeValue) {
                                foundNext = true;
                            }
                        }
                    }
                    if (!foundOption && firstMatch) {
                        foundOption = firstMatch;
                    }
                    if (foundOption) {
                        const optionElement = instance.getOption(foundOption[instance.settings.valueField]);
                        if (optionElement) {
                            instance.setActiveOption(optionElement);
                        }
                    }
                } else {
                    typeaheadString += currentChar;
                    lastSearchChar = currentChar;
                    const options = instance.options;
                    let foundOption = null;
                    for (let value in options) {
                        const option = options[value];
                        const optionText = (option.text || option[instance.settings.labelField] || '').toLowerCase();
                        if (optionText.startsWith(typeaheadString)) {
                            foundOption = option;
                            break;
                        }
                    }
        ...
        ;
        instance.control.addEventListener('keydown', handleKeyDown);
    }
    getDropdownPosition(dropdown, control, dropdownDirection) {
        let upPositionOBJ = {
            top: "auto",
            bottom: "100%"
        }
    ...
    createTomSelectInstance($this, config) {
        const {direction, themeType, hasExplain, disableSearch, ajaxUrl, placeholder, dropdownDirection} = config;
        const self = this;
        if (!themeType || themeType === 'align_image' || themeType === 'schedule_module') {
            if (!$this.get(0).id) {
                $this.get(0).id = `tmpselect-${new Date().getTime()}`;
            }
            const instance = new TomSelect($this[0],{
                ...
                render: this.renderTheme(themeType, hasExplain),
                dir: direction,
                onDropdownOpen: function(dropdown) {
                    const position = self.getDropdownPosition(dropdown, this.control, dropdownDirection);
                    dropdown.style.top = position.top;
                    dropdown.style.bottom = position.bottom;
                    self.closeOtherDropdowns();
                }
            });
            if (disableSearch) {
        ...
        if (themeType === 'customers') {
            return new TomSelect($this[0],{
                plugins: ['remove_button'],
                create: true,
                maxItems: 1,
                render: this.renderTheme(themeType, ''),
                dir: direction,
                valueField: 'email',
                labelField: 'name',
                searchField: 'name',
                ...
                onInitialize: function() {
                    $(this.wrapper).attr('data-id', $this.attr('id'));
                    const value = $this.data('selected-customer');
                    if (value) {
                        const url = ajaxUrl + '?q=' + encodeURIComponent(value) + '&w=' + encodeURIComponent($this.data('website-id'));
                        fetch(url).then(response => response.json()).then(json => {
                            if (json && json.length) {
                                this.addOption(json[0]);
                                this.setValue(json[0].email);
                            }
                        }
                        );
                    }
                ...
                onFocus: function() {
                    if (!config.loadedInitialData) {
                        this.load('');
                        config.loadedInitialData = true;
                    }
                },
                load: function(query, callback) {
                    const url = ajaxUrl + '?q=' + encodeURIComponent(query) + '&w=' + encodeURIComponent($this.data('website-id'));
    ...
    setupDirectionClasses(instance, direction) {
        if (direction == 'rtl') {
            instance.control.classList.add('rtl');
            instance.dropdown.classList.add('rtl');
        } else {
            instance.control.classList.add('ltr');
            instance.dropdown.classList.add('ltr');
        }
    }
    calculateAutoWidth($select, instance) {
        const autoWidthEnabled = $select.data('option-auto-width');
        if (!autoWidthEnabled)
            return;
        const selectStyle = window.getComputedStyle($select[0]);
        const hasExplicitWidth = $select[0].style.width || $select.attr('width');
        if (hasExplicitWidth && hasExplicitWidth !== 'auto') {
            return;
        }
        const measurer = $('<span>').css({
            ...
            // Match TomSelect control padding (10px left, 30px right for dropdown icon)
        }).appendTo('body');
        let maxWidth = 0;
        $select.find('option').each(function() {
            const text = $(this).text();
            measurer.text(text);
            const width = measurer.outerWidth();
            if (width > maxWidth) {
                maxWidth = width;
            }
        });
        measurer.remove();
        const minWidth = 150;
        // Minimum width to prevent too narrow selects
        const maxAllowedWidth = 500;
        // Maximum width to prevent overflow from parent container
        const calculatedWidth = Math.max(maxWidth + 20, minWidth);
        const finalWidth = Math.min(calculatedWidth, maxAllowedWidth);
        // Apply max-width constraint
        if (instance.wrapper) {
            instance.wrapper.style.width = finalWidth + 'px';
        }
    }
    renderTheme(themeType, hasExplain) {
        if (themeType == 'align_image') {
            return {
                option: (data, escape) => {
                    const w = data.srcW || 24;
                    const h = data.srcH || 24;
                    if (data.src) {
                        return `<div class="optionImage"><img src="${data.src}" width="${w}" height="${h}">${data.text}</div>`;
                    }
                    if ($('select.uiRichSelect').find('option[data-src]').length > 0) {
                        return `<div class="optionImage"><div style="width:${w}px;height:${h}px;display:inline-block;"></div>${data.text}</div>`;
                    }
                    return `<div class="optionImage">${data.text}</div>`;
                }
                ,
                item: (item, escape) => {
                    const w = item.srcW || 24;
                    const h = item.srcH || 24;
                    if (item.src) {
                        return `<div class="optionImage"><img src="${item.src}" width="${w}" height="${h}">${item.text}</div>`;
                    }
                    if ($('select.uiRichSelect').find('option[data-src]').length > 0) {
                        return `<div class="optionImage"><div style="width:${w}px;height:${h}px;display:inline-block;"></div>${item.text}</div>`;
                    }
...
<span class="optionTitle">${escape(item.text)}</span>&nbsp;${item.email ? `<span style="font-size: 90%;" class="optionExplain">(${escape(item.email)})</span>` : ''}
        ...
        if (hasExplain) {
            return {
                option: (item, escape) => `<div class="optionExplainItem"><div class="optionTitle">${item.text}</div><div class="optionExplain">${item.explain}</div></div>`
            };
        }
        return null;
    }
    closeOtherDropdowns() {
        if (typeof $.fn.multiselect !== 'undefined') {
            $('select.uiMultipleSelect').each(function() {
                try {
    ...
    observeDisabledState(selectElement) {
        if (!$(selectElement).is('SELECT') || !$(selectElement).hasClass('uiRichSelect'))
            return;
        const instance = selectElement.tomselect;
        let isHandlingChange = false;
        const observer = new MutationObserver( (mutations) => {
            mutations.forEach( (mutation) => {
                if (mutation.type === 'attributes' && mutation.attributeName === 'disabled' && mutation.target.tagName === 'SELECT' && !isHandlingChange) {
                    // Only proceed if we're not already handling a change
...
$(document).ready( () => {
    new UiRichSelect();
    $(document).on('click', '.uiMultipleSelectContainer .btn-group button, .multiselect.dropdown-toggle', function() {
        $('.uiRichSelect').each(function() {
            if (this.tomselect) {
